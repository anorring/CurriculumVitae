...
In my course work I have tried to emphasize maintaining, updating and improving my methodological know-how. I have taken courses on e.g. open data science (R, open data sources, Git). This summer I'm updating my knowledge on DSGE models, Bayesian times series methods, different classes of VARs and Bayesian methods for DSGE models at the Dynare Summer School and the Barcelona GSE Macroeconometrics Summer School. 
...
**5/2018** Presenting "Macroprudential policy cross-border spillovers and international banking - Any use for the gravity model?", HECER Research Workshop on Macroeconomics

**5/2018** Presenting "Macroprudential policy cross-border spillovers and international banking - Any use for the gravity model?", Bank of Finland internal seminar
...
For more on this paper, please refer to my [GitHub repository](https://github.com/anorring/PHDthesis_1st_paper). 
...
## 5.2 Publications for the general public, such as analyses, articles and blogs
